...
/**
 * Translates actual map coordinates into relative coordinates to account for and create a scrolling effect
 * @author User Fletch from SlickForums -- edited by C. Scott
 * @version 0.8
 */
public class Camera 
{
